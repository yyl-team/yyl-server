...
define('rDemo',['ajax'], function(ajax) {
    var wDemo = {
        init: function() {
            var logoEl = document.getElementById('logo');
            var tEl = document.getElementById('t');
            var imageUrl = '/project/1/pc/images/components/r-demo/images/logo-2021d0ef33.png';
            var i;
            var iClass = [0, 1, 2, 3];
...
define("components/p-demo/p-demo.js", function(){});
